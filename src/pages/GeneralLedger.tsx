...
const GeneralLedger = () => {
  ...
  return (
    <AppLayout title="General Ledger" subtitle="Chart of accounts, journals & consolidation">
      <Tabs defaultValue="chart" className="space-y-6">
        <TabsList className="h-auto flex-wrap gap-1 p-1 bg-muted/50">
          ...
          <TabsTrigger value="multi-book" className="gap-2 text-xs sm:text-sm">
            <BookOpen className="h-4 w-4" />
            <span className="hidden sm:inline">Multi-Book</span>
            <span className="sm:hidden">Books</span>
          </TabsTrigger>
          <TabsTrigger value="intercompany" className="gap-2 text-xs sm:text-sm">
            <GitMerge className="h-4 w-4" />
            <span className="hidden sm:inline">Intercompany</span>
