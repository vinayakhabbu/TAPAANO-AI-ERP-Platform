...
serve(async (req) => {
  ...
  try {
    ...
    const { org_id, mode = "preview", types = ["purchase_order", "payment_run", "purchase_requisition"] } = await req.json();
